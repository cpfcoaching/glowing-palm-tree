...
```mermaid
flowchart LR
    A[Week 1: Telemetry & Top 20 Refresh] --> B[Week 2: Engagement & Pinned Debate Loops]
    B --> C[Week 3: Guest Co-Amplification Engine]
    C --> D[Week 4: Shorts-to-Longform Conversion Bridge]
    D --> A
```
